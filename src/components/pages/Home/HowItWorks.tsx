  ...
  return (
    <div>
      ...
      <div  className="grid  grid-cols-1 md:grid-cols-3 md:grid-rows-3 p-2 md:p-0 md:w-[90%] lg:w-[70%] mx-auto gap-4 m-10">
        ...
        {/* Card two */}
        <div data-aos="flip-right" data-aos-delay="1000" data-aos-duration="1000" className=" md:col-span-2  bg-[#f682a5] rounded-xl p-4  amoled-shadow">
        ...
        {/* card three */}
        <div data-aos="flip-up" data-aos-delay="1000" data-aos-duration="1000" className="  bg-[#c4d68c] rounded-xl p-4 space-y-2  amoled-shadow flex flex-col justify-center items-center ">
          <Image
            className="rounded-xl bg-none object-fill bg-slate-800"
        ...
        {/* card four */}
        <div data-aos="flip-right" data-aos-delay="1000" data-aos-duration="1000" className=" bg-[#ffdf70] rounded-xl p-4 space-y-2  amoled-shadow flex flex-col justify-center items-center ">
          <Image
            className="rounded-xl bg-none object-fill bg-slate-800"
        ...
        {/* card five */}
        <div data-aos="flip-right" data-aos-delay="1000" data-aos-duration="1000" className="md:col-span-2  bg-[#f8a475] rounded-xl p-4 relative flex flex-row-reverse  amoled-shadow  justify-center items-center ">
          <div>
            <Image
        ...
        {/* card six  */}
        <div data-aos="flip-right" data-aos-delay="1000" data-aos-duration="1000" className="  bg-[#b8cedc] rounded-xl p-4 flex flex-col justify-center  amoled-shadow items-center ">
          <Image
            className="rounded-full bg-none object-fill bg-slate-800  right-4"
